...
func main() {
	...
	router.HandleFunc("/secret", Chain(internal.SecretListHandler, ContextAdd(ctx)))
	...
	router.HandleFunc("/api/secret-detail", Chain(internal.SecretDetailHandler, ContextAdd(ctx)))
