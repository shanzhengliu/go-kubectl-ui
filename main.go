...
func main() {
	...
	router.HandleFunc("/secrect", Chain(internal.SecretListHandler, ContextAdd(ctx)))
	...
	router.HandleFunc("/api/secrect-detail", Chain(internal.SecretDetailHandler, ContextAdd(ctx)))
